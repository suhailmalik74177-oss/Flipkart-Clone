...
function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // key name should match what multer expects on backend
      ...
      if (res.success && res.user) {
        ...
        const frontendUser = {
          ...
          profilePic: res.user.ProfilePic || profilePic,
          joinedDate: res.user.createdAt || new Date().toISOString(),
        };
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
      <div className="flex bg-white shadow-2xl rounded-2xl overflow-hidden w-[900px] max-w-full flex-col sm:flex-row">
        <div className="hidden sm:flex w-2/5 bg-blue-600 text-white flex-col justify-center items-center p-8 relative">
          ...
          />
          <p className="absolute bottom-4 text-xs opacity-80">© 2025 Flipkart Clone UI</p>
        </div>
        ...
        <div className="w-full sm:w-3/5 p-6 sm:p-10 flex flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col items-center justify-center mb-4">
              ...
              <p className="text-xs text-gray-500 mt-2">Upload a profile picture (optional)</p>
            </div>
